      ...
      <main className="flex-1">
        <div className="container-px py-12">
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mt-12">
              <h2 className="text-2xl font-serif font-semibold mb-6">Core Model</h2>
            ...
            {/* Products Section */}
            <div className="mt-16">
              <h2 className="text-2xl font-serif font-semibold mb-6">Product Lineup</h2>
              <p className="lead mb-8 max-w-prose">
                FarmOS로 데이터 기반 농업을 운영하고, MMC로 초기비용을 낮추며 확장성을 확보하세요.
              </p>
              <div className="grid grid-cols-12 gap-6">
                <div className="col-span-12 md:col-span-6 lg:col-span-4 card p-6" id="farmos">
                  <h3 className="text-xl font-semibold">Farm OS</h3>
